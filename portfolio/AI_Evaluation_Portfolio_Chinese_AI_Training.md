...
**Target roles:** Chinese AI Evaluator / Mandarin AI Trainer / AI Response Rater / Language Evaluation Contributor  
...
**Statement:** These samples are self-created evaluation examples. They do not include internal tasks from any platform, proprietary prompts, confidential materials, or copied platform tests.
